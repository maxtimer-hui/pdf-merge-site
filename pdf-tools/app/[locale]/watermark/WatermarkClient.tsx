      ...
      <main className="container mx-auto px-4 py-12">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="text-center mb-8">
            <div className="w-20 h-20 bg-gradient-to-br from-cyan-500 to-blue-500 rounded-full flex items-center justify-center mx-auto mb-4 text-4xl">
              💧
            </div>
              ...
              <div className="space-y-6">
                ...
                {!result && (
                  <button
                    ...
                    disabled={processing}
                    className="w-full bg-gradient-to-r from-cyan-500 to-blue-500 text-white py-3 rounded-lg font-semibold hover:from-cyan-600 hover:to-blue-600 transition-all disabled:bg-gray-400 disabled:cursor-not-allowed"
                  >
