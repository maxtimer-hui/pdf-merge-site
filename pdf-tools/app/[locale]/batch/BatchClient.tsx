...
export default function BatchClient({ params }: { params: Promise<{ locale: string }> }) {
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 mb-6">
            ...
            {files.length > 0 && (
              <div className="mt-6">
                <div className="flex justify-between items-center mb-4">
                  <h3 className="font-semibold">{t('selectedFiles', { count: files.length })}</h3>
            ...
            {files.length > 0 && !processing && results.length === 0 && (
              <button
                ...
                className="w-full mt-6 bg-gradient-to-r from-purple-600 to-pink-600 text-white py-3 rounded-lg font-semibold hover:from-purple-700 hover:to-pink-700 transition-all"
              >
                {t('startBatchProcess')}
              </button>
            )}
