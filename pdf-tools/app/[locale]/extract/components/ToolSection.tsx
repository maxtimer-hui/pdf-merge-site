      ...
      <div className="bg-white rounded-lg shadow-lg p-8 mb-6">
        {!file ? (
          ...
          <div className="space-y-6">
            ...
            <div>
              <h3 className="text-lg font-semibold mb-3">{t('selectExtractMode')}</h3>
            ...
            {(extractMode === 'all' || extractMode === 'even' || extractMode === 'odd') && (
              <div className="p-3 bg-blue-50 rounded-lg">
                <p className="text-sm text-blue-800">
                  {extractMode === 'all' && t('extractAllInfo', { count: totalPages })}
                  {extractMode === 'even' && t('extractEvenInfo', { count: Math.floor(totalPages / 2) })}
                  {extractMode === 'odd' && t('extractOddInfo', { count: Math.ceil(totalPages / 2) })}
                </p>
              </div>
            )}
            ...
            {!result && (
              ...
              >
                {extracting ? tc('processing') : t('extract')}
              </button>
            )}
          </div>
        )}
      ...
      {result && (
        <div className="bg-white rounded-lg shadow-lg p-8">
          <div className="text-center mb-6">
            ...
            <p className="text-gray-600">{t('extractSuccess')}</p>
          </div>
