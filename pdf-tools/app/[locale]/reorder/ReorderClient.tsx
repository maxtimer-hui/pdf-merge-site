...
export default function ReorderClient({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-violet-50/100">
      <Navbar currentLocale={locale} />
      <main className="container mx-auto px-4 py-12">
        <div className="max-w-3xl mx-auto">
          <Link href={`/${locale}`} className="inline-flex items-center text-indigo-600 hover:text-indigo-800 mb-6">
